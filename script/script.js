...
function BusStopInfo()
{
	...
	var stopEstimatesJSON = "http://api.translink.ca/rttiapi/v1/stops/"
		...
		+ "&routeNo=" + routeNumber;
	var translinkURL = corsAnywhereURL + stopEstimatesJSON;
...
/*
	var data =
		...
		Access-Control-Allow-Origin: 'http://api.translink.ca'
		}
	// make json call
	$.getJSON( translinkURL, data, onSuccess)
		.fail(onFailure);
		

var url = transLinkURL;
